...
> Source material for an explicitly authorized native host automation. Verify committed paths and integration capabilities first; this template does not itself create or activate anything.
