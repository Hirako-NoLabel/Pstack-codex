...
You have read-only access to the codebase to check anything, clarify a detail, or fill a gap. Use the available file-reading and search tools as needed. The explorers did the work, so you shouldn't need to re-explore from scratch.
