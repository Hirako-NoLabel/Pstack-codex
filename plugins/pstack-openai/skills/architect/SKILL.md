...
Use `panels.architect_runners` in `.pstack/config.json`. The default is four independent agents inheriting the parent model, scheduled within available capacity. Do not claim model-family diversity unless actually configured and available.
