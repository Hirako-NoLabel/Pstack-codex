...
- **Source control history**: {file paths}, {number of commits reviewed}, PRs #{numbers}, and code comments searched. Or "Not searched. State whether repository history, git, or authenticated PR access was unavailable."
